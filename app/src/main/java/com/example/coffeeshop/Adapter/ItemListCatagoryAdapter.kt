...
class ItemListCatagoryAdapter(val items: MutableList<ItemsModel>):
    RecyclerView.Adapter<ItemListCatagoryAdapter.Viewholder>(){
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): ItemListCatagoryAdapter.Viewholder {
    ...
    override fun onBindViewHolder(holder: ItemListCatagoryAdapter.Viewholder, position: Int) {
